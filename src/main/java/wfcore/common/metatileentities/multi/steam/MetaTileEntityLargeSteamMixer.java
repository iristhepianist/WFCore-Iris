...
public class MetaTileEntityLargeSteamMixer extends RecipeMapSteamMultiblockController {

    private static final int PARALLEL_LIMIT = 8;

    public MetaTileEntityLargeSteamMixer(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntityLargeSteamMixer(metaTileEntityId);
    }
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start().start(RIGHT, FRONT, DOWN)
                .aisle("#######","###A###","###A###","#AAAAA#","###A###","###A###","#######")
                .aisle("###A###","###A###","#######","AA#B#AA","#######","###A###","###A###")
                .aisle("###A###","#######","#######","A##C##A","#######","#######","###A###")
                .aisle("#AAAAA#","A#####A","A#####A","A##C##A","A#####A","A#####A","#AAAAA#")
                .aisle("#AASAA#","AD###DA","A#D#D#A","A##B##A","A#D#D#A","AD###DA","#AAAAA#")
                .aisle("#AAAAA#","AAAAAAA","AAAAAAA","AAAAAAA","AAAAAAA","AAAAAAA","#AAAAA#")
