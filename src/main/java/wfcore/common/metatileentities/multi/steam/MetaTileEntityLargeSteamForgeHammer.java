...
public class MetaTileEntityLargeSteamForgeHammer extends RecipeMapSteamMultiblockController {

    private static final int PARALLEL_LIMIT = 8;

    public MetaTileEntityLargeSteamForgeHammer(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntityLargeSteamForgeHammer(metaTileEntityId);
    }
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start().start(RIGHT, FRONT, DOWN)
                ...
                .where('C', blocks(Blocks.IRON_BLOCK))
