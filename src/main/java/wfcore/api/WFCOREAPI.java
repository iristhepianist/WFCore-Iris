    ...
    */
    public static void init() {
        ...
        MAP_FUSION_COIL.put(MetaBlocks.FUSION_CASING.getState(BlockFusionCasing.CasingType.SUPERCONDUCTOR_COIL),
                new WrappedIntTired(BlockFusionCasing.CasingType.SUPERCONDUCTOR_COIL, 1));
        MAP_FUSION_COIL.put(MetaBlocks.FUSION_CASING.getState(BlockFusionCasing.CasingType.FUSION_COIL),
                new WrappedIntTired(BlockFusionCasing.CasingType.FUSION_COIL, 2));
        ...
        */
        MAP_CPU_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_VENT),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_VENT, 0));
        MAP_CPU_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_CPUI),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_CPUI, 1));
        MAP_CPU_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_CPUII),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_CPUII, 2));
        MAP_CPU_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_CPUIII),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_CPUIII, 3));


        MAP_GPU_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_VENT),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_VENT, 0));
        MAP_GPU_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_GPUI),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_GPUII, 1));
        MAP_GPU_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_GPUII),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_GPUI, 2));
        MAP_GPU_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_GPUIII),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_GPUIII, 3));

        MAP_RAM_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_VENT),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_VENT, 0));
        MAP_RAM_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_RAMI),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_RAMI, 1));
        MAP_RAM_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_RAMII),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_RAMII, 2));
        MAP_RAM_CASING.put(WFCoreMetaBlocks.COMPUTERPARTS.getState(WFCoreComputerParts.CasingType.COMPUTER_RAMIII),
                new WrappedIntTired(WFCoreComputerParts.CasingType.COMPUTER_RAMIII, 3));
